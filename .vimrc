...
map <M-t> :tabe <CR>
map <M-s> :split <CR>
map <silent> <C-c> :'<,'>w !xclip -selection clipboard <CR> <CR>
...
let g:ale_cpp_clang_options = '-c -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fno-plt -std=gnu++11 -D_REENTRANT -Wall -W -fPIC -DQT_DEPRECATED_WARNINGS -DQAMQP_SHARED -DQT_NO_DEBUG -DQT_PLUGIN -DQT_QUICK_LIB -DQT_MULTIMEDIA_LIB -DQT_GUI_LIB -DQT_QML_LIB -DQT_NETWORK_LIB -DQT_DBUS_LIB -DQT_CORE_LIB -I. -I/home/nox/projects/eole/hygia/pulse/cm3/qt/qt5pi/plugins/qamqp -isystem /usr/include/qt -isystem /usr/include/qt/QtQuick -isystem /usr/include/qt/QtMultimedia -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtQml -isystem /usr/include/qt/QtNetwork -isystem /usr/include/qt/QtDBus -isystem /usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++'
